...
AUTHENTICATION_BACKENDS = [
    "apps.accounts.backends.EmailOuUsernameBackend",
...
SITE_NAME = config("SITE_NAME", default="enoschofficiel")
SITE_DESCRIPTION = config(
    "SITE_DESCRIPTION", default="Votre source d'information fiable"
)
